# Low Motion Profile Switcher (`low-motion-profile-switcher`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://low-motion-profile-switcher.sociobot.in`. Artifact class: `browser-extension`.
